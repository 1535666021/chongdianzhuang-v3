...
export function getShortName(name: string, category: MaterialCategory): string {
  ...
  if (n.includes('5*10') || n.includes('5×10') || n.includes('5x10') || n.includes('5X10')) return '电缆5*10'
  if (n.includes('5*16') || n.includes('5×16') || n.includes('5x16') || n.includes('5X16')) return '电缆5*16'
  if (n.includes('5*6') || n.includes('5×6') || n.includes('5x6') || n.includes('5X6')) return '电缆5*6'
  if (n.includes('4*10') || n.includes('4×10') || n.includes('4x10') || n.includes('4X10')) return '电缆4*10'
  if (n.includes('4*6') || n.includes('4×6') || n.includes('4x6') || n.includes('4X6')) return '电缆4*6'
  if (n.includes('2*6') || n.includes('2×6') || n.includes('2x6') || n.includes('2X6')) return '电缆2*6'
  if (n.includes('2*4') || n.includes('2×4') || n.includes('2x4') || n.includes('2X4')) return '电缆2*4'
